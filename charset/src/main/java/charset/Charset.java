...
public class Charset {
     ...
     * MS949
     *      EUC-KR 에서 확장됨 (Microsoft window)
     *      알파벳은 1byte, 한글문자는 2byte 범위
     *      드물게 사용되는 한글문자가 추가됨
     * UTF-8 (사실상 표준이다.)
     *      ASCII 에서 확장
     ...
     *
     * 참고.
     * 한글문자가 깨지는 가장 큰 이유 2가지
     * 1. EUC-KR(MS949) 과 UTF-8 사이에서 서로 호환이 안됨.
     *      서로 매핑테이블이 다름
     * 2. EUC-KR(MS949) 또는 UTF-8 과 ISO-8859-1 사이에서 발생
     *      ISO-8859-1 는 한글문자 자체가 지원안된다.
     *
     */
}
